...
public class Kontroller {
    ...
    public void configure() {
        ...
        main.setPlayListener(e -> {main.setVisible(false);game.setVisible(true);setWordSet();gc.setGermanToHungarian(settings.isGermanToHungarian());gc.setStartingState();game.setExitVisibility(true);});
        ...
        game.setFinishButtonListener(e -> {endingScreen.setVisible(true);endingScreen.setResultText(gc.getResultsAsString());game.setVisible(false); game.setFinishVisible(true);});
